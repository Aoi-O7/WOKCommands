            ...
            return __generator(this, function(_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        guild = message.guild;
                        if (!guild) {
                            message.channel.send(instance.messageHandler.get(guild, 'CANNOT_CHANGE_REQUIRED_ROLES_IN_DMS'));
                            return [2 /*return*/ ];
                        }
                    ...
                    case 1:
                        _a.sent();
                        message.channel.send(instance.messageHandler.get(guild, 'REMOVED_ALL_REQUIRED_ROLES', {
                            COMMAND: command.names[0],
                        }));
                        return [3 /*break*/ , 4];
                    case 2:
                    ...
                    case 3:
                        _a.sent();
                        message.channel.send(instance.messageHandler.get(guild, 'ADDED_REQUIRED_ROLE', {
                            ROLE: roleId,
                            COMMAND: command.names[0],
                        }));
                        _a.label = 4;
