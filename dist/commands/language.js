            ...
            return __generator(this, function(_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (!lang) {
                            message.channel.send(instance.messageHandler.get(guild, "CURRENT_LANGUAGE", {
                                LANGUAGE: instance.messageHandler.getLanguage(guild),
                            }));
                            return [2 /*return*/ ];
                        }
                        if (!messageHandler.languages().includes(lang)) {
                            message.channel.send(messageHandler.get(guild, "LANGUAGE_NOT_SUPPORTED", {
                                LANGUAGE: lang,
                            }));
                        ...
                        message.channel.send(instance.messageHandler.get(guild, "NEW_LANGUAGE", {
                            LANGUAGE: lang,
                        }));
