            ...
            return __generator(this, function(_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        message.channel.send(instance.messageHandler.get(guild, 'CURRENT_PREFIX', {
                            PREFIX: prefix,
                        }));
                        return [3 /*break*/ , 4];
                    case 1:
                    ...
                    case 2:
                        ...
                        message.channel.send(instance.messageHandler.get(guild, 'SET_PREFIX', {
                            PREFIX: text,
                        }));
                        return [3 /*break*/ , 4];
                    case 3:
                        message.channel.send(instance.messageHandler.get(guild, 'CANNOT_SET_PREFIX_IN_DMS'));
                        _a.label = 4;
                    case 4:
                        return [2 /*return*/ ];
                }
