            ...
            client.on("message", function(message) {
                ...
                if ((cooldown || globalCooldown) && user) {
                    ...
                    if (timeLeft) {
                        if (error) {
                            ...
                            message.channel.send(instance.messageHandler.get(guild, "COOLDOWN", {
                                COOLDOWN: timeLeft,
                            }));
                        }
                        return;
                ...
                if (guild) {
                    ...
                    if (channels &&
                        ...
                        message.channel.send(instance.messageHandler.get(guild, "ALLOWED_CHANNELS", {
            ...
            return __generator(this, function(_f) {
                switch (_f.label) {
                    ...
                    case 4:
                        return [3 /*break*/ , 7];
                    case 5:
                        return [4 /*yield*/ , slashCommands.create(names[0], description, options)];
                    case 6:
                        _f.sent();
                        _f.label = 7;
                    case 7:
    ...
    Object.defineProperty(CommandHandler.prototype, "commands", {
        get: function() {
            ...
            this._commands.forEach(function(_a) {
                var names = _a.names,
                    _b = _a.category,
                    category = _b === void 0 ? "" : _b,
                    _c = _a.description,
                    description = _c === void 0 ? "" : _c,
                    _d = _a.expectedArgs,
                    expectedArgs = _d === void 0 ? "" : _d,
                    _e = _a.hidden,
                    hidden = _e === void 0 ? false : _e,
                    _f = _a.testOnly,
                    testOnly = _f === void 0 ? false : _f;
    ...
    CommandHandler.prototype.fetchDisabledCommands = function() {
        ...
        return __awaiter(this, void 0, void 0, function() {
            ...
            return __generator(this, function(_b) {
                switch (_b.label) {
                    case 0:
                        return [4 /*yield*/ , disabled_commands_1.default.find({})];
                    case 1:
                        results = _b.sent();
    ...
    CommandHandler.prototype.fetchRequiredRoles = function() {
        return __awaiter(this, void 0, void 0, function() {
            ...
            return __generator(this, function(_b) {
                switch (_b.label) {
                    case 0:
                        return [4 /*yield*/ , required_roles_1.default.find({})];
                    case 1:
                        results = _b.sent();
    ...
    CommandHandler.prototype.fetchChannelOnly = function() {
        ...
        return __awaiter(this, void 0, void 0, function() {
            ...
            return __generator(this, function(_b) {
                switch (_b.label) {
                    case 0:
                        return [4 /*yield*/ , channel_commands_1.default.find({})];
                    case 1:
                        results = _b.sent();
